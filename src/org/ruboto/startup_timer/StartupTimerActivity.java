...
public class StartupTimerActivity extends org.ruboto.RubotoActivity {
    ...
    public static void setStop(long newStop) {
	stop = newStop;
    }
    ...
    private void initJRuby(final boolean firstTime) {
        new Thread(new Runnable() {
            public void run() {
                final boolean jrubyOk = Script.setUpJRuby(StartupTimerActivity.this);
                if (jrubyOk) {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            if (firstTime) {
                                ...
                                Toast.makeText(StartupTimerActivity.this,"Failed to initialize Ruboto Core.",Toast.LENGTH_SHORT).show();
                                try {
